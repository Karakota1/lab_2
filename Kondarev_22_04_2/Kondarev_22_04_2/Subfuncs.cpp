...
int Menu()
{
	std::cout << "\n1.Добавить трубу" << endl
		<< "2.Добавить КС" << endl
		<< "3.Добавить соединение" << endl //Топологическая сортировка и поиск кратчайшего пути
		<< "4.Список объектов" << endl
		<< "5.Редактировать объекты" << endl
		<< "6.Работа с соединениями" << endl
